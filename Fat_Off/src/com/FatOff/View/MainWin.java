...
public class MainWin {
	...
	public MainWin(Object nut, String type) {
		...
		sessionDataPanel.setBorder(new TitledBorder(new LineBorder(new Color(184, 207, 229)), "Session Data",
		...
		gl_mainPanel.setHorizontalGroup(gl_mainPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_mainPanel.createSequentialGroup()
						.addComponent(logoPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(sessionDataPanel, GroupLayout.DEFAULT_SIZE, 788, Short.MAX_VALUE).addGap(7)));
		gl_mainPanel.setVerticalGroup(gl_mainPanel.createParallelGroup(Alignment.LEADING).addGroup(gl_mainPanel
				.createSequentialGroup()
				.addGroup(gl_mainPanel.createParallelGroup(Alignment.LEADING)
						.addComponent(logoPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(sessionDataPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
		...
		gl_sessionDataPanel.setHorizontalGroup(gl_sessionDataPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_sessionDataPanel.createSequentialGroup().addContainerGap()
						.addGroup(gl_sessionDataPanel.createParallelGroup(Alignment.LEADING, false)
								.addComponent(diaticianNameLbl, GroupLayout.PREFERRED_SIZE, 114,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(customerNameLbl, GroupLayout.PREFERRED_SIZE, 114,
										GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.RELATED)
						...
						.addGroup(
								gl_sessionDataPanel.createParallelGroup(Alignment.LEADING)
										.addComponent(dateLbl, GroupLayout.PREFERRED_SIZE, 53,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(sessionNumLbl, GroupLayout.PREFERRED_SIZE, 53,
												GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_sessionDataPanel.createParallelGroup(Alignment.LEADING, false)
						...
						.addGroup(gl_sessionDataPanel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_sessionDataPanel.createSequentialGroup()
										.addComponent(bmiLbl, GroupLayout.PREFERRED_SIZE, 32,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(bmiTxtPane, GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE))
								.addGroup(gl_sessionDataPanel.createSequentialGroup()
										.addComponent(eerLbl, GroupLayout.PREFERRED_SIZE, 32,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(eerTxtPane, GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE)))
						.addGap(133)));
		gl_sessionDataPanel.setVerticalGroup(gl_sessionDataPanel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_sessionDataPanel.createSequentialGroup().addContainerGap().addGroup(gl_sessionDataPanel
						.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_sessionDataPanel.createParallelGroup(Alignment.TRAILING, false)
								.addComponent(bmiTxtPane, Alignment.LEADING, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addComponent(bmiLbl, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
								.addComponent(dieticianNameTxtPane, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
								.addComponent(diaticianNameLbl, GroupLayout.PREFERRED_SIZE, 21,
										GroupLayout.PREFERRED_SIZE))
						.addComponent(dateLbl, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
						.addComponent(dateTxtPane, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_sessionDataPanel.createParallelGroup(Alignment.TRAILING)
								...
								.addComponent(eerTxtPane, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(customerNameTxtPane, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(sessionNumTxtPane, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGap(7)));
		...
		logoLbl.setIcon(new ImageIcon(
				MainWin.class.getResource("/com/FatOff/View/imgonline-com-ua-resize-5aRADIEx30404X17.png")));
