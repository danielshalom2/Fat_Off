...
;
		...
		lblNewLabel_1.setIcon(new ImageIcon(SignInTest2.class.getResource("/com/FatOff/View/imgonline-com-ua-resize-5aRADIEx30404X17.png")));
		lblNewLabel_1.setForeground(Color.WHITE);
		lblNewLabel_1.setFont(new Font("Century Gothic", Font.PLAIN, 14));
		panel.add(lblNewLabel_1);
		
		JLabel yourIdWarnLbl = new JLabel("");
		yourIdWarnLbl.setBounds(324, 128, 229, 14);
		yourIdWarnLbl.setFont(new Font("Century Gothic", Font.BOLD, 11));
		...
		separator_2.setBounds(324, 128, 229, 27);
		...
		yourIdField.setBounds(324, 106, 229, 27);
	
		yourIdField.setFont(new Font("Century Gothic", Font.PLAIN, 12));
