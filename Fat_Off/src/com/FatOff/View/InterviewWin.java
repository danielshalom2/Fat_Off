		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(248)
					.addComponent(copyRightLbl, GroupLayout.DEFAULT_SIZE, 374, Short.MAX_VALUE)
					.addGap(102))
		);
				...
				.addGroup(gl_panel.createSequentialGroup()
					.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(Alignment.LEADING, gl_panel.createSequentialGroup()
							.addContainerGap()
							.addComponent(interviewScrollPane, GroupLayout.DEFAULT_SIZE, 751, Short.MAX_VALUE))
						.addGroup(Alignment.LEADING, gl_panel.createSequentialGroup()
							.addGap(14)
							...
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel.createSequentialGroup()
									.addGap(18)
									.addComponent(txtpnWelcomeToThe, GroupLayout.DEFAULT_SIZE, 604, Short.MAX_VALUE))
								.addGroup(gl_panel.createSequentialGroup()
									.addGap(74)
		...
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(interviewScrollPane, GroupLayout.PREFERRED_SIZE, 406, GroupLayout.PREFERRED_SIZE)
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(18)
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
